          ...
          <Popover>
            ...
            <PopoverContent color={"black"}>
              ...
              <PopoverBody fontSize="18px" textAlign="center">
                ...
                <Divider />
                The Green color tiles show the letter to be at right spot.
                <br></br>
                The Yellow color tiles show the letter is present in the word
                but it is not placed at correct spot.<br></br>
                The Gray color tiles show the letter is not present in the word.
              </PopoverBody>
              <PopoverFooter fontSize="18px" textAlign="center">
                There are a hints provide for each word that'll only appear
                after 4th failed attempts.<br></br>
        ...
        <span size="lg">
          <Popover>
            ...
            <PopoverContent color={"black"}>
              ...
              <PopoverBody fontSize="18px" textAlign="center">
                This Seven Letters Wordle Game is the Clone of the Official
                Wordle game, which is developed by Welsh software engineer Josh
                Wardle, and owned and published by The New York Times Company
                since 2022.
                <Divider />
